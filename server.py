...
def schelling_draw(agent):
    ...
    if agent is None:
        return
    if agent.introverty == 0:
        portrayal = {"Shape": "circle", "r": 0.5, "Filled": "true", "Layer": 0}
    if agent.introverty == 1:
        portrayal = {"Shape": "rect", "h": 0.3, "w": 0.3, "Filled": "false", "Layer": 0}
...
model_params = {
    ...
    "introverty_limit": mesa.visualization.Slider("Antissocial", 0.1, 0.00, 0.2, 0.01),
}
